    ...
    router.post("/vote", async (req, res: any) => {
        ...
        try {
            ...
            if (!studentID || typeof studentID !== "string") {
                logger.error(`(/vote): Invalid or missing studentID. questionID=${questionID}, optionID=${optionID}`);
                return res.json({ ok: false, message: "studentID is required and must be a string." });
            }
